...
namespace Stock.ReportForm
{
    public partial class ProductsReport : Form
    {
        ...
        {
            cryrpt.Load(@"D:\WindowsAplikacije\Stock\Stock\Reports\Product.rpt");
            SqlConnection con = new SqlConnection("Data Source=PC-PC\\SQLEXPRESS;Initial Catalog=Stock;Integrated Security=True");
            con.Open();
